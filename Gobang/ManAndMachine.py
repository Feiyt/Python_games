...
def _draw_right_info(screen, font, cur_runner, player1_wins, player2_wins):
    ...
    p1_score_rect = p1_score_surf.get_rect(
        midleft=(p1_score_indicator_pos[0] + Stone_Radius2 + 10, p1_score_indicator_pos[1]))
    ...
    p2_score_rect = p2_score_surf.get_rect(
        midleft=(p2_score_indicator_pos[0] + Stone_Radius2 + 10, p2_score_indicator_pos[1]))
...
class AI:
            ...
            for j in range(self._line_points):
                if self._checkerboard[j][i] == 0:
                    ...
                    if _score == score and point is not None:
                        ...
                        dist_sq_old = (point.X - (self._line_points // 2)) ** 2 + (
                                    point.Y - (self._line_points // 2)) ** 2
    ...
    def _get_direction_score(self, point, x_offset, y_offset):
        ...
        if count >= 4:  # Forms 5-in-a-row
            ...
            if live_ends_my == 2:
                my_score = 1000  # Live four
            elif live_ends_my == 1:
                my_score = 100  # Dead four
        elif count == 2:
            if live_ends_my == 2:
                my_score = 100  # Live three
            elif live_ends_my == 1:
                my_score = 10  # Dead three
        elif count == 1:
            if live_ends_my == 2:
                my_score = 10  # Live two
            elif live_ends_my == 1:
                my_score = 1  # Dead two
        ...
        if _count >= 4:  # Block opponent's 5-in-a-row
            ...
            if live_ends_opp == 2:
                opp_score = 900  # Block live four
            elif live_ends_opp == 1:
                opp_score = 90  # Block dead four
        elif _count == 2:
            if live_ends_opp == 2:
                opp_score = 90  # Block live three
            elif live_ends_opp == 1:
                opp_score = 9  # Block dead three
        elif _count == 1:
